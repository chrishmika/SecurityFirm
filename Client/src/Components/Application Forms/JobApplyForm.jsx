...
const JobApplyForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post('http://localhost:8000/api/employeeform',
        formData, 
        {
        headers: {
      ...
      <form onSubmit={handleSubmit}>
        <div>
          ...
          <div className="bg-blue-50 p-4 rounded-lg mb-4">
            ...
            {hasExperience === true && (
              <>
                ...
                <div className="mb-5">
                  <label className="text-gray-900 text-sm font-medium mb-2">
                    Do you have experience in handling firearms or weapons as part of your job?{" "}
                  </label>
                  <select
                    className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5"
                    value={handlingGuns }
                    onChange={(e) => setHandlingGuns (e.target.value === "1")}
                    required
                  >
                    <option value="*">Please choose</option>
                    <option value="1">Yes</option>
          ...
          <div className="bg-green-50 p-4 rounded-lg mb-4">
            ...
            <div className="mb-5">
              <label className="text-gray-900 text-sm font-medium mb-2">
                Upload a recent photo of your government-issued ID:{" "}
              </label>
            ...
            {hasExperience === true && (
              <div className="mb-5">
                <label className="text-gray-900 text-sm font-medium mb-2">
                  GS certification (JPG, JPEG, PNG ,pdf):{" "}
                </label>
                <input
                  className="block w-full bg-gray-50 border text-sm border-gray-300 p-2.5 rounded-lg"
                  type="file"
