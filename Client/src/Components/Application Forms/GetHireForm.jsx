...
const GetHireForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const apiUrl = 'http://localhost:8000/api/hire';
  ...
  return (
    <div className='bg-white lg:w-[500px] sm:w-100 '>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="mb-5">
          <label
            className='text-gray-900 text-sm font-medium mb-2'>Full Name : </label>
          <input className='bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 p-2.5 w-full '
            type="text"
        ...
        <div className="mb-5">
          ...
          <input 
            ...
            value={mobile}
            required placeholder='000-00000000' />
          {errors.mobile && <p className="text-red-500 text-xs mt-1">{errors.mobile}</p>}
        </div>

        <div className="mb-5">
          <label className='text-gray-900 text-sm font-medium mb-2' htmlFor="">Service Location : </label>
          <input className='bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 p-2.5 w-full ' type="text"
        ...
        <div className="mb-5">
          ...
          <input className='bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 p-2.5 w-full ' type="text"
            ...
            value={nearestCity}
            required placeholder='Enter nearest city' />
        </div>
        ...
        <div
          ...
          <div className='flex justify-between'>
            <div className='pr-4'>
              <label className='text-gray-900 text-sm font-medium mb-2' htmlFor="">Start of service date</label>
              <input className='bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 p-2.5 w-full ' type="date"
            ...
            <div className=''>
              ...
              <input className='bg-gray-50 border border-gray-300 rounded-lg text-gray-900 text-sm focus:ring-blue-500 focus:border-blue-500 p-2.5 w-full ' type="number" min="1" step="1"
        ...
        <div className='mb-5'>
          ...
          <textarea name="" id="" className="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" rows="5" placeholder='Provide additional details : Specific days, Hours ... '
