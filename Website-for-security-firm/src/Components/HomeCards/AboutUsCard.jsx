                            ...
                            <div className="space-y-6">
                                ...
                                <div className="prose prose-lg text-slate-700 leading-relaxed">
                                    <p className="mb-6 text-lg">
                                        We are a <span className="font-semibold text-slate-900">dedicated security manpower provider</span>, offering professional guarding and protective services to businesses, residential communities, and events across <span className="font-medium text-blue-700">[your coverage area, e.g., the UK]</span>, where traditional security solutions may fall short.
                                    </p>

                                    <p className="mb-6">
                                        Like major utilities, we operate under <span className="font-semibold text-slate-900">strict industry regulations</span> (e.g., [PSA/SIA/ACS] in the UK) and ensure all our personnel are licensed, vetted, and trained to the highest standards. We specialize in <span className="font-medium text-indigo-700">New Security Contracts (NSCs)</span>, stepping in where existing security providers cannot meet demand or require reinforcement.
                                    </p>

                                    <p className="mb-0">
                                        We partner with property developers, facility managers, event organizers, and private clients to deliver <span className="font-semibold text-slate-900">tailored security solutions</span>—from static guards and mobile patrols to emergency response teams. Our end-to-end service includes risk assessments, manpower deployment, and ongoing quality audits to guarantee compliance and performance.
                                    </p>
                                </div>
