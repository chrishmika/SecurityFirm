  ...
  return (
    <footer className="relative bg-gradient-to-br from-gray-900 via-slate-900 to-gray-800 text-white pt-16 pb-8 px-4 sm:px-6 lg:px-8 overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        ...
        <div className="absolute bottom-0 right-0 w-96 h-96 bg-indigo-500 rounded-full filter blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
      </div>
      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-12">
            ...
            <ul className="space-y-3">
              {['Home', 'Services', 'Training Programs', 'Client Portal'].map((link, index) => (
                <li key={index} className="group">
                  <a href="#" className="text-gray-300 hover:text-blue-400 transition-all duration-300 flex items-center space-x-2 group-hover:translate-x-1">
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-lg mb-4 relative">
              <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Resources</span>
              <div className="absolute bottom-0 left-0 w-12 h-0.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"></div>
            </h4>
            <ul className="space-y-3">
          ...
          <div className="space-y-4">
            <h4 className="font-semibold text-lg mb-4 relative">
              <span className="bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Legal</span>
              <div className="absolute bottom-0 left-0 w-12 h-0.5 bg-gradient-to-r from-blue-500 to-indigo-500 rounded-full"></div>
            </h4>
            <ul className="space-y-3">
              {['Privacy Policy', 'Terms of Service', 'Cookie Policy', 'Licenses'].map((link, index) => (
                <li key={index} className="group">
                  <a href="#" className="text-gray-300 hover:text-blue-400 transition-all duration-300 flex items-center space-x-2 group-hover:translate-x-1">
                    <div className="w-1 h-1 bg-gray-500 rounded-full group-hover:bg-blue-400 transition-colors duration-300"></div>
                    <span>{link}</span>
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          ...
          <div className="flex space-x-4">
            ...
            <a href={`tel:${phoneNumber}`} className="group relative">
              ...
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Call</span>
            </a>
            ...
            <a href={whatsappUrl} className="group relative">
              ...
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">WhatsApp</span>
            </a>
            ...
            <a href="#" className="group relative">
              ...
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Facebook</span>
            </a>
            ...
            <a href="#" className="group relative">
              ...
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">LinkedIn</span>
            </a>
            ...
            <a href="#" className="group relative">
              ...
              <span className="absolute -bottom-8 left-1/2 transform -translate-x-1/2 text-xs text-gray-500 opacity-0 group-hover:opacity-100 transition-opacity duration-300">Twitter</span>
            </a>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center space-y-4">
          ...
          <a href="#top" className="inline-flex items-center space-x-2 text-gray-400 hover:text-blue-400 transition-all duration-300 group">
