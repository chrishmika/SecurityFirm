      ...
      <div className="container mx-auto relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 leading-relaxed">
              Providing elite security personnel and cutting-edge protection services since 2023.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-3">
              {[
                ...
                { name: "WhatsApp", path: whatsappUrl },
              ].map((link, index) => (
                <li key={index} className="group">
                  <Link
                    to={link.path}
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
          ...
          <div className="text-gray-400 text-sm text-center lg:text-left">
            <p className="mb-1">© 2025 Team MI16 . All rights reserved.</p>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-700 text-center space-y-4">
          <p className="text-gray-500 text-sm">
            Website by <span className="text-blue-400 font-semibold">Team MI16®</span>
          </p>
        </div>
      </div>
    </footer>
