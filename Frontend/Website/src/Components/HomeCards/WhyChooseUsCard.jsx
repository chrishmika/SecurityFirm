      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Discover what sets us apart in the security industry and why businesses trust us with
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                {reasons.map((reason, index) => (
                  <div
                    ...
                    <div
                      className={`absolute inset-0 bg-gradient-to-r ${reason.gradient} rounded-2xl opacity-0 group-hover:opacity-100 transition-opacity duration-300 -z-10`}></div>
                    ...
                    <div className="relative z-10">
                      ...
                      <div className="flex items-center mb-4">
                        <div
                          className={`w-12 h-12 rounded-full bg-gradient-to-r ${reason.gradient} flex items-center justify-center text-white text-xl font-bold mr-4 shadow-lg group-hover:scale-110 transition-transform duration-300`}>
                          {reason.icon}
                        </div>
                        <div
                          className={`w-8 h-1 bg-gradient-to-r ${reason.gradient} rounded-full`}></div>
                      </div>
